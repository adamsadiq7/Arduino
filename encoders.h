...
volatile long e0_old;
volatile long e0_new;

volatile unsigned long e1_interval;
volatile unsigned long e1_last_time;
volatile long e1_old;
volatile long e1_new;



/* 
 *  each count = 0.15mm distance travelled by the wheel
 */
...
ISR( INT6_vect ) {
  ...
  e1_speed = (e1_new-e1_old)*0.00015/(e1_interval*0.000001);
  e1_last_time = micros();
  e1_old = e1_new;
...
ISR( PCINT0_vect ) {
  ...
  e0_speed = (e0_new-e0_old)*0.00015/(e0_interval*0.000001);
  e0_last_time = micros();
  e0_old = e0_new;
